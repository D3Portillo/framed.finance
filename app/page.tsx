...
import { FaCoins, FaArrowUp, FaWallet, FaMoneyBillWave } from "react-icons/fa"
import { IoMdMenu } from "react-icons/io"
import { HiCreditCard } from "react-icons/hi2"
import { RiCoinsFill, RiMoneyDollarBoxFill, RiRobot2Fill } from "react-icons/ri"
      ...
      <main className="max-w-md h-dvh overflow-hidden mx-auto flex flex-col">
        ...
        <header className="flex items-center justify-between p-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-full pl-1.5 py-1.5 pr-4 flex items-center gap-2">
            <figure className="size-6 rounded-full bg-linear-to-br from-green-400 to-blue-500" />
            <span className="text-sm font-medium">0xA206C1</span>
          </div>
        ...
        <section className="flex-1 flex flex-col items-center justify-start pt-16 px-4">
          ...
          <div className="flex items-center gap-4">
            <button className="bg-green-600/20 backdrop-blur-sm rounded-full pl-4 pr-3 py-1.5 flex items-center gap-2 hover:bg-green-600/30 transition-colors">
              <span className="text-green-400 font-medium">$0 earned</span>
              <IoInformationCircleOutline className="text-green-400 text-xl" />
            </button>
          ...
          <div className="grid mt-18 grid-cols-4 gap-2 w-full max-w-sm">
            <button className="bg-ff-yellow text-black backdrop-blur-sm rounded-xl p-3 gap-1 flex flex-col items-center justify-center hover:bg-ff-yellow/90 transition-colors">
          ...
          <div className="w-full mt-8 max-w-sm">
            ...
            {/* Transaction Item */}
            <div className="flex border border-white/3 items-center gap-4 p-4 rounded-xl bg-white/3 hover:bg-white/6 transition-colors">
              <div className="w-12 h-12 rounded-full bg-red-500/10 flex items-center justify-center">
                <TbArrowUpRight className="text-red-500 text-2xl" />
              </div>
